/****************************************************************************
** Meta object code from reading C++ file 'rulewindow.h'
**
...
#include "../src/rulewindow.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'rulewindow.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 11, 10), // "insertRule"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 10), // "removeRule"
QT_MOC_LITERAL(4, 34, 11), // "currentRule"
QT_MOC_LITERAL(5, 46, 17), // "QTableWidgetItem*"
QT_MOC_LITERAL(6, 64, 4) // "item"

    },
    "RuleWindow\0insertRule\0\0removeRule\0"
    "currentRule\0QTableWidgetItem*\0item"
};
...
void RuleWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->insertRule(); break;
        case 1: _t->removeRule(); break;
        case 2: _t->currentRule((*reinterpret_cast< QTableWidgetItem*(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject RuleWindow::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_RuleWindow.data,
